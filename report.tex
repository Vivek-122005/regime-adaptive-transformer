...
Transformer architectures have been applied to financial time series in work such as the Temporal Fusion Transformer \cite{lim2021} and various attention-based forecasting models. Applications to cross-sectional equity selection are less common, and reported gains over simpler factor-based baselines are modest.
